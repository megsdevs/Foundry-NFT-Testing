...
contract ShellzOrbTest is Test {
    // proxy admin contract to control proxy, see https://docs.openzeppelin.com/contracts/3.x/api/proxy#ProxyAdmin
...
contract ShellzOrbWorkingTest is Test {
    // proxy admin contract to control proxy, see https://docs.openzeppelin.com/contracts/3.x/api/proxy#ProxyAdmin
    // mainnet impl v2 contract
    ShellzOrbV2 implementation = ShellzOrbV2(address(0x0a1618A6F0b9D3E37DC673AB1cd67471760bC06A));
    // mainnet admin contract
...
contract ShellzOrbWorkingTest2 is Test {
    // proxy admin contract to control proxy, see https://docs.openzeppelin.com/contracts/3.x/api/proxy#ProxyAdmin
    // mainnet impl v2 contract
    ShellzOrbV2 implementation = ShellzOrbV2(address(0x0a1618A6F0b9D3E37DC673AB1cd67471760bC06A));
    // mainnet admin contract
    ...
    function setUp() external {
        ...
        implementation = new ShellzOrbV2();
